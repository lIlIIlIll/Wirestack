...
| Release qualification SDK | Cangjie STS `1.1.3`；local path `<home>/cangjie_sdk/sts1.1.3`；current candidate qualification pending |
...
发布基线已从 STS `1.1.0` 迁移到 `<home>/cangjie_sdk/sts1.1.3`
