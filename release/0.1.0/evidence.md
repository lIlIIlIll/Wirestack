...
run 为 [`34555702124`](https://github.com/lIlIIlIll/yjson/actions/runs/34555702124)；
...
| Hosted PR CI | PASS | PR [#26](https://github.com/lIlIIlIll/yjson/pull/26) run `34555702124` conclusion=`success`；Seven-library evidence drift、registry rehearsal、Pure Windows/macOS、Coverage、Cangjie STS 和 CI Required 均通过 |
