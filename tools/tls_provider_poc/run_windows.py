...
only the build/link/dependency-inspection details required by a native MSYS2
UCRT64 toolchain on a GitHub-hosted Windows runner.
"""
...
def build_provider(
    ...
    if spec["id"] != "openssl":
        return base.build_provider(spec, src, work, log)
