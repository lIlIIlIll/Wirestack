...
```bash
<home>/.codex/scripts/codex_cangjie_env scripts/repo-doctor
```
...
```bash
<home>/.codex/scripts/codex_cangjie_env scripts/check-fast
<home>/.codex/scripts/codex_cangjie_env scripts/check-full
```
...
```bash
<home>/.codex/scripts/codex_cangjie_env scripts/check-m7-027-linux-examples
```
