...
3. `python3 -m json.tool docs/references/stdx-http1-baseline-linux.data`
   - Exit 0.
4. `env DISABLE_ZOXIDE=1 <home>/.codex/scripts/codex_cangjie_env --cwd <repo-root> python3 tools/benchmarks/http1_benchmark.py --stdx-archive /tmp/cangjie-stdx-linux-x64-1.1.3.1.zip --stdx-root /tmp/wirestack-stdx-1.1.3.1.sAN2Jp --output docs/evidence/M5-030/linux_x86_64/http1-benchmark.json`
   - Exit 0; overall PASS.
