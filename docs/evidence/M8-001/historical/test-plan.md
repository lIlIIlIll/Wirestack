...
| T002 | P001,P002,P003,P004,P005 | `<home>/.codex/scripts/codex_cangjie_env cjpm check` and `cjpm build` | PASS |
| T003 | P002,P003,P004,P005 | `<home>/.codex/scripts/codex_cangjie_env cjpm test src/net` | PASS outside the restricted socket sandbox; sandbox-only failure is environment evidence |
...
| T005 | P006 | `<home>/.codex/scripts/codex_cangjie_env cjpm test src/http --no-progress --no-color` | PASS (75/75) |
