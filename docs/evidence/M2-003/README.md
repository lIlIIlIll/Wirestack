...
```text
env DISABLE_ZOXIDE=1 <home>/.codex/scripts/codex_cangjie_env --cwd <repo-root> scripts/gate-m2-003-resolver-pool --output-dir docs/evidence/M2-003/linux_x86_64
```
