...
- GitHub Actions run: `33361148426`
- workflow: `M2-004 Windows SystemResolver`
- tested revision: `c80be395d67523efaed28b35d139a8e36aad5610`
...
|---|---|---|
| Native Windows integration | GitHub `windows-2025` run `33361148426` | PASS |
