...
- GitHub Actions run: `33336104695`
- workflow: `M2-004 Windows SystemResolver`
- tested revision: `a46a6e9e78701a74d01f988e34ba5a2b5896f1fe`
...
|---|---|---|
| Native Windows integration | GitHub `windows-2025` run `33336104695` | PASS |
