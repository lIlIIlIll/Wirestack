...
```text
env DISABLE_ZOXIDE=1 <home>/.codex/scripts/codex_cangjie_env --cwd <repo-root> scripts/gate-m2-005-system-resolver --output-dir /tmp/wirestack-m2-005-glibc-gate
```
...
```text
env DISABLE_ZOXIDE=1 <home>/.codex/scripts/codex_cangjie_env --cwd <repo-root> cjpm build -i
```
