...
| T022 | S023 | P025 | Static workflow contract plus GitHub-hosted execution | PASS/BLOCKED | Required commands and fail-closed syntax are present; remote run and ruleset evidence must both pass | CI,supply-chain |
