...
- `<home>/.codex/scripts/codex_cangjie_env --cwd /tmp/wirestack-m7029-final-review.t9LCwO/repo cjpm check` — exit 0; `cjpm check success`; provider cache manifest-validated and resolver absent initially.
