...
Status: complete candidate acceptance PASS. `task-check.json` records the task commands. `evidence.json` records the final source candidate and report bindings; publication and merge remain separate gates.
...
| T014 | P001,P002,P003,P004,P005,P006,P007,P008,P009,P010 | S001,S002,S003,S004,S005,S006,S007,S008,S010,S011,S012,S013,S014,S015,S016,S017,S018,S019,S020,S021,S022 | [`http-tests.json`](http-tests.json) records 108 passed and 3 skipped. [`protocol-tests.json`](protocol-tests.json) records 292 passed and 3 skipped. Both have zero failures | PASS |
