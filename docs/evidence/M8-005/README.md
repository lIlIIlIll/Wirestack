...
The [Linux HTTP guide](../../guides/http-parity-linux.md) describes public use and ownership. The [test plan](test-plan.md) maps 11 paths and 32 scenarios to 21 executed rows.
...
| [HTTP facade tests](http-tests.json) | 102 passed, 3 skipped, zero failures |
...
| [Full repository check](full-check.json) | PASS. Cangjie: 750 passed, 23 skipped, zero failures |
