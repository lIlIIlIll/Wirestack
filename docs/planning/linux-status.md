...
| Transport SPI | IN_PROGRESS | Core types, listener, lifecycle, half-close fallback, stable std.net errors, and transport diagnostics are qualified. M1-024 race qualification and M1-025 milestone evidence remain. |
...
1. Run M1-024 deterministic races.
2. Assemble M1-025
