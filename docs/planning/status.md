...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Schema v8 supersedes all 12 retained schema-v7 desktop results pending native reruns with bounded effective build-environment evidence. Android, iOS and HarmonyOS or OpenHarmony native-device evidence also remains missing. |
