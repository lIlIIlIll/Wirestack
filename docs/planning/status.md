...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Schema-v9 desktop evidence is superseded. Schema-v10 native reruns are pending for distinct local-close coverage and strengthened source, archive, diagnostic and PARTIAL-state validation. Android, iOS and HarmonyOS or OpenHarmony native-device evidence remains missing. |
