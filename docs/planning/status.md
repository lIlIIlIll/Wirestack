...
|---|---|---|---|
| M8-001 | COMPLETE | [`docs/evidence/M8-001/README.md`](../evidence/M8-001/README.md) | Shared Internet/Unix endpoint and bounded network contracts; retained lifecycle and exact-read diagnostics; real-commit source-bound sealing and derived task totals. All eight task commands pass: 612 Cangjie cases pass, 23 performance cases excluded; network 22/22, tooling 33/33; API docs cover 1,093 symbols and 430 parameters. Native TCP transfer and truncated-read diagnostics pass; later protocol/privileged I/O is not claimed. |
