...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | All 12 desktop cells have current schema-v8 native evidence with bounded effective build-environment provenance: AWS-LC passes on Linux glibc, Linux musl, macOS and Windows; Mbed TLS and the vendored OpenSSL control retain explicit capability gaps as PARTIAL. Android, iOS and HarmonyOS or OpenHarmony native-device evidence remains missing. |
