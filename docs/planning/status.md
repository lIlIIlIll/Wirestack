...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Current schema-v4 native desktop evidence passes AWS-LC on Linux glibc, Linux musl, macOS and Windows and retains comparison-provider gaps; Android, iOS and Harmony native-device evidence remains missing. |
