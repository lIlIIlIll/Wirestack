...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | All 12 desktop schema-v11 cells are current: AWS-LC passes on Linux glibc, Linux musl, Windows and macOS; Mbed TLS and OpenSSL retain explicit PARTIAL results. GitHub-hosted Android emulator and iOS Simulator gates plus the fail-closed retention helper are defined, but no mobile VM artifacts have been retained yet; physical Android/iOS device and HarmonyOS/OpenHarmony native evidence remains missing. |
