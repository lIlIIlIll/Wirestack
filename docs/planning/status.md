...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | AWS-LC glibc/musl/Windows schema-v2 results PASS every capability; nine retained comparison cells are PARTIAL, while Android/iOS/Harmony native evidence remains missing. |
