...
| P1-014 | COMPLETE | [`docs/evidence/P1-014/README.md`](../evidence/P1-014/README.md) | All 305 digest calls have explicit text, artifact-byte or typed-implementation domains across Python, scripts and workflows; schema v2, checkout-bound Linux and hosted Windows CRLF fault injection, task-level validation and canonical repository checks pass. Historical schema-v1 evidence remains rejected rather than silently promoted. |
