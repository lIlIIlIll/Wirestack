...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Previous desktop schema-v10 evidence is stale after the schema-v11 assembler-provenance contract change. Twelve native desktop reruns and Android, iOS and HarmonyOS or OpenHarmony native-device evidence remain missing. |
