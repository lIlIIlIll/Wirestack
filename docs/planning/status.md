...
| M2-006 | COMPLETE | [`docs/evidence/M2-006/README.md`](../evidence/M2-006/README.md) | GitHub hosted `macos-15` arm64 and iOS Simulator arm64 execution pass all eight resolver cases at exact SHA `a1062bf`; reports retain platform, toolchain, source digests, cancellation, Deadline, network-change and lifecycle evidence. |
