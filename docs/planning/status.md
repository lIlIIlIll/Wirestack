...
| M7-030 | COMPLETE | [`docs/evidence/M7-030/README.md`](../evidence/M7-030/README.md) | GitHub-hosted run `33318194490` verified OIDC/Sigstore attestations for the frozen artifact, SBOM and release manifest on merge commit `8367a4eae8c4d46600dc1d20e571e9a3ddf5a493`. Local tamper rejection, clean-consumer, provider update and authorized rollback rehearsals also pass. |
| M7-031 | COMPLETE | [`docs/evidence/M7-031/README.md`](../evidence/M7-031/README.md) | The fail-closed Linux candidate report evaluates all 22 PRD release criteria: 21 PASS, 0 FAIL and Android/iOS listener acceptance is NOT_APPLICABLE_TO_LINUX_PROFILE. It binds the exact soaked, fuzzed, benchmarked, reviewed and hosted-attested artifact and records `GO_FOR_LINUX_STABLE_RELEASE`; no non-Linux completion is claimed. |
...
| M7-033 | COMPLETE | [`docs/evidence/M7-033/README.md`](../evidence/M7-033/README.md) | PR #155 merged as `ec2e8236625c5f45625750c1a4ed947f2dcf8c9c`; repaired STS 1.1.3 CI and main Pages deployment passed. The revision-bound smoke artifact records four HTTP 200 responses. Pages uses workflow-only publication; live API search/navigation passed. |
...
| P1-016 | COMPLETE | [task scope](../evidence/P1-016/README.md); [test plan](../evidence/P1-016/test-plan.md); [verification](../evidence/P1-016/verification.json); [evidence index](../evidence/P1-016/evidence.json) | Both retained M7 signing jobs are guarded and the active workflow is manual-only. Source candidate 68485da811c73930105f39c77f67c3b233ed6208 and evidence head e01d6d1ce9e17fbc73bb8098acc372d1a73dd7d0 each have 11/11 successful workflow runs; PR checks pass with only the main-documentation deployment skipped. No manual dispatch or new attestation was performed; M8-007 remains the active signer. |
...
| M8-002 | COMPLETE | [`docs/evidence/M8-002/README.md`](../evidence/M8-002/README.md) | Public Linux `TcpListener`/`UdpSocket`; IPv4/IPv6 native consumer verifies descriptor flags, atomic packets, empty receive, truncation/source ownership, peer filtering, active cancellation/close, opposite-direction progress and 64 resource cycles per family. Empty send is explicitly Unsupported on this backend. All 12 task commands pass: network 48/48, transport 34 passed with 17 existing Performance exclusions, full Cangjie 639 passed with 23 exclusions, repository regressions 116/116. API inventory: 262 declarations and 103 aliases; docs: 1,118 symbols and 450 parameters, all documented. Source-bound evidence records the intentional pre-1.0 ABI change and requires consumer rebuild. |
| M8-003 | COMPLETE | [`docs/evidence/M8-003/README.md`](../evidence/M8-003/README.md) | Public Unix stream/listener and capability-scoped datagrams; independent peers verify exact names/bytes, EOF, EAGAIN-gated cancellation/close, non-replayable backpressured write timeout, pathname replacement guard and 64 resource cycles per profile. Short/non-UTF8 outgoing abstract names, Unix connected send, unnamed datagram source conversion and raw I/O remain explicitly blocked. All 12 commands pass: network 48/48; transport 33 passed with 17 existing Performance exclusions; full Cangjie 638 passed with 23 exclusions; selected Python regressions 116/116. API: 265 declarations, 103 aliases; docs: 1,163 symbols and 492 parameters fully documented. The new capability field requires consumer rebuild. |
| M8-004 | COMPLETE | [`docs/evidence/M8-004/README.md`](../evidence/M8-004/README.md) | Bounded DNS parsing, validated UDP/TCP fallback, hosts/search policy, LRU and scoped negative caching, lookup-wide CNAME limits and shared-deadline connection. All 12 acceptance commands pass: 103 network tests; 50 transport/connector tests with 17 skips; twelve native modes; full check 693 passed with 23 skips; 116 selected tooling tests. PR corrections preserve deadlines, usable address families, queued cancellation and endpoint diagnostics; reserve failover budget; bound summary counts; canonicalize and deduplicate nameserver scopes; preserve exact fallback names; resolve IPv4 literals without DNS; accept maximum-length canonical names; retain live negative, interpretation and cross-family conflict peers; stop on name-wide NXDOMAIN independently of cacheability; and stop querying once result capacity is full. Adopted-client settings must match; hosts scopes are canonical; NXDOMAIN invalidates stale targets and dependent aliases while preserving existing negative lifetimes. Paired DNS fixtures reserve TCP before UDP. Deterministic parser mutation testing covers 8,544 inputs. No DNSSEC, encrypted DNS, other-platform or final-release claim. |
| M8-005 | COMPLETE | [`docs/evidence/M8-005/README.md`](../evidence/M8-005/README.md) | All fourteen Linux HTTP acceptance commands pass, including the pinned PSL and upload commit-boundary checks. HTTP facade: 110 passed, 3 skipped. HTTP protocol: 297 passed, 3 skipped. Five installed consumer modes cover 131,072-byte HTTP/2 push and file context-stop classification. Full check: 765 passed, 23 skipped. Selected tooling: 240 passed. API: 314 declarations, 110 aliases. Documentation: 1,443 symbols and 689 parameters, fully documented; HTML uses a separate generator process. Origin-relative PSL boundaries, overlay rejection and secure-aware quota eviction protect cookie state. Transferred push bodies retain request cancellation and deadlines. HTTP/2 half-close preserves admitted DATA ordering and caller-bounded graceful close. Bounded mutations cover all three parsers and invalid multipart metadata closes owned input. No compression, non-Linux file, performance or final-release claim. |
| M8-006 | COMPLETE | [`docs/evidence/M8-006/README.md`](../evidence/M8-006/README.md) | All fourteen acceptance commands pass. Focused TLS: 75/75. Installed release: 13/13 plus rejection of direct raw-RSA service readback through a public context. Isolated keylog: 5/5 plus native SNI/keylog boundary. Full check: 773 passed, 23 skipped. Tooling: 254 passed. API: 324 declarations, 114 aliases. Strict documentation, browser navigation and rendering pass. New exhaustive-enum cases require source updates and consumer rebuilds; no binary compatibility guarantee. Source and reports are commit-bound. No production key logging, hardware-device qualification, performance or final-soak claim. |
| M8-007 | BLOCKED | [replacement status](../evidence/M8-007/requalification-status.json); [identity audit](../evidence/M8-007/evidence-identity-audit.json) | Replacement qualification uses SDK 1.1.3. Outbound fixed-length body-limit regression is fixed (HTTP/1: 119 passed, 3 skipped); bounded Huffman tree passes all 182 HTTP/2 cases and reduces the measured maximum-input median from 5590 ms to 49 ms. Corrected installed artifact and ten-target fuzz campaign pass. Historical M7 evidence mismatch and incomplete independent review remain blockers. Previous soak and signatures do not qualify the corrected candidate; fresh formal soak, authorized production signatures and sealing remain required. |

M8-005 and M8-006 have qualified Linux HTTP and TLS evidence. M8-007 retains
...
| M9-002 | COMPLETE | [#171](https://github.com/lIlIIlIll/Wirestack/issues/171); [acceptance evidence](../evidence/M9-002/README.md); [source seal](../evidence/M9-002/evidence.json); [candidate execution](../evidence/M9-002/publication.json) | Typed TCP/listener/UDP options, accepted policy and effective native queries pass on Linux x86_64 glibc with SDK 1.1.3. Local source/seal commits only; completion requires the schema-2 index to verify against the exact candidate. Push, PR, merge and release remain unauthorized. Unix options and M9-003 membership remain out of scope. |
| M9-003 | COMPLETE | [#172](https://github.com/lIlIIlIll/Wirestack/issues/172); [acceptance evidence](../evidence/M9-003/README.md); [source seal](../evidence/M9-003/evidence.json); [candidate execution](../evidence/M9-003/publication.json) | Linux x86_64 glibc qualification remains bound to source candidate `890fd78111bc6dea5aeb67ead968a70118c65601` and passes all 18 native scenarios; repository checks and generated API/HTML docs reported 100% symbol and parameter coverage. The refreshed schema-2 seal now includes 306 source inputs, including the runner, installed consumer and lifecycle tests, all unchanged from that qualified candidate. Candidate and seal are published in PR #192; merge and production release are not included. |
