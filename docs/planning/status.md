...
| M8-007 | IN_PROGRESS | [`docs/evidence/M8-007/README.md`](../evidence/M8-007/README.md) | Fresh native rebuild, deterministic artifact, clean installation, current API baseline, SBOM and licenses pass. Independent review, hosted signatures and the final 86,400-second candidate soak remain open. Preflights do not qualify the formal gate. |
