...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Current schema-v5 native evidence covers all 12 Linux glibc, Linux musl, macOS and Windows provider cells with exact execution identity, mTLS modes, license payloads, bounded profiles and supported diagnostics; Android, iOS and Harmony native-device evidence remains missing. |
