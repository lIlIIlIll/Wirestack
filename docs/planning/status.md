...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Twelve schema-v3 native results are retained: AWS-LC passes Linux glibc, Linux musl, macOS and Windows; Mbed TLS/OpenSSL controls remain PARTIAL, and Android/iOS/Harmony native evidence is missing. |
