...
| P1-016 | IN_PROGRESS | [task scope](../evidence/P1-016/README.md); [test plan](../evidence/P1-016/test-plan.md) | The retired M7 Linux attestation workflow is being made valid but non-signing; exact-head GitHub Actions validation and evidence sealing are pending. |
