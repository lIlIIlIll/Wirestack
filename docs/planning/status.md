...
| M7-033 | COMPLETE | [`docs/evidence/M7-033/evidence.json`](../evidence/M7-033/evidence.json) | Linux developer documentation, cjdoc 0.7.2 layered generation, strict coverage gate, clean consumer and GitHub Pages deployment/smoke passed on merge SHA `2f3def83c8903b592faf83edf95a0bc334a94d20`; long profiles and non-Linux gates were not run. |
