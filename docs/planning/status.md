...
| P1-016 | IN_PROGRESS | [task scope](../evidence/P1-016/README.md); [test plan](../evidence/P1-016/test-plan.md); [verification](../evidence/P1-016/verification.json); [evidence index](../evidence/P1-016/evidence.json) | The previous evidence seal is stale after synchronizing current main. Regenerate and bind verification.json to the merged candidate revision; no manual dispatch or new attestation. M8-007 remains the active signer. |
