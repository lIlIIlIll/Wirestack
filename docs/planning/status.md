...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Desktop schema-v10 reruns are pending for independent archive-tag resolution and explicit fresh-handshake cache-miss assertions. Android, iOS and HarmonyOS or OpenHarmony native-device evidence remains missing. |
