...
| M8-007 | IN_PROGRESS | [`docs/evidence/M8-007/README.md`](../evidence/M8-007/README.md) | Initial artifact and installation qualification passed, then independent review found five release blockers. Source corrections require fresh qualification. Hosted signatures and the final 86,400-second candidate soak remain open; preflights cannot satisfy that gate. |

M8-005 and M8-006 have qualified Linux HTTP and TLS evidence. M8-007 is the next
release gate: rebuild the final artifact and retain a new 86,400-second
final-candidate soak. It cannot inherit earlier qualification.
