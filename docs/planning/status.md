...
| M7-033 | IN_PROGRESS | [`docs/evidence/M7-033/README.md`](../evidence/M7-033/README.md) | CI repair and PR checks pass with STS 1.1.3. Current acceptance remains incomplete until the repaired pipeline deploys from main and its new Pages smoke report is indexed against a published merge revision. Historical Pages evidence is not reused for this repair. |
