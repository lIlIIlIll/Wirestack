...
| M7-022 | BLOCKED | [`docs/evidence/M7-022/README.md`](../evidence/M7-022/README.md) | The 10-second installed-artifact preflight passes, but the final 86,400-second run is intentionally deferred until M7-032 and M7-029 finish and the release candidate artifact is regenerated. No short result is treated as acceptance. |
...
| M7-028 | COMPLETE | [`docs/evidence/M7-028/README.md`](../evidence/M7-028/README.md) | The Linux independent-review package covers threat model, architecture, provider and C ABI, parsers and bounds, key/trust handling, fuzz, SBOM, known limits, environment and reproduction. Its fail-closed index records 4 current PASS, 7 stale-after-M7-032 and 1 historical non-gating evidence entry; pre-1.0 compatibility is not a release gate. |
| M7-029 | COMPLETE | [`docs/evidence/M7-029/README.md`](../evidence/M7-029/README.md) | A fresh no-history process-isolated reviewer accepted package `9d4c4676cd52883aa002e20946b474ac2777d7fcee2bcfe9c232436c44aeaf82`: 2 Critical and 14 High findings are Fixed, no Critical or High remains open, and all nine task commands pass. One open Medium finding retains final-candidate regeneration and long-profile work for later release tasks. |
| M7-030 | BLOCKED | — | Depends on M7-022, M7-025 and M7-029. |
