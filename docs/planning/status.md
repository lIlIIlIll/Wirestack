...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Schema-v4 desktop evidence is superseded and all desktop cells are NOT_RUN pending schema-v5 native reruns; Android, iOS and Harmony native-device evidence also remains missing. |
