...
| M8-006 | READY | Not yet produced | M8-002 and M8-005 are qualified. TLS context versioning and external-key hooks require their own branch and native evidence. |

M8-005 has qualified Linux HTTP evidence. M8-006 is READY.
M8-007 remains pending and cannot inherit earlier socket, DNS or HTTP qualification.
