...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Schema v7 supersedes all 12 retained schema-v6 desktop results pending native reruns with bounded join and cleanup live-allocation evidence. Android, iOS and HarmonyOS or OpenHarmony native-device evidence also remains missing. |
