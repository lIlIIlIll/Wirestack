...
| M8-004 | COMPLETE | [`docs/evidence/M8-004/README.md`](../evidence/M8-004/README.md) | Bounded DNS parsing, validated UDP/TCP fallback, hosts/search policy, LRU and scoped negative caching, lookup-wide CNAME limits and shared-deadline connection. All 12 acceptance commands pass: 85 network tests; 50 transport/connector tests with 17 skips; eleven native modes; full check 675 passed with 23 skips; 116 selected tooling tests. PR corrections preserve caller deadlines, usable address families and queued cancellation. Deterministic parser mutation testing covers 8,544 inputs. No DNSSEC, encrypted DNS, other-platform or final-release claim. |
