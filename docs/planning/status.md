...
| M7-033 | IN_PROGRESS | [`docs/evidence/M7-033/README.md`](../evidence/M7-033/README.md) | Linux developer documentation, cjdoc 0.7.2 layered generation, strict coverage gate and GitHub Pages workflow are being implemented. Completion remains fail-closed until exact 0.7.2 artifacts and hosted Pages smoke are current. |
