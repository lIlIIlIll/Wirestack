...
| M8-007 | COMPLETE | [`docs/evidence/M8-007/README.md`](../evidence/M8-007/README.md) | Final Linux x86_64 glibc release qualified. Candidate e94a1ffb passed the dedicated 86,400-second soak with artifact digest 58965727; signing source ffd65516 was independently approved, protected hosted attestations passed, and the complete task gate passed. |

M8-005 and M8-006 have qualified Linux HTTP and TLS evidence. M8-007 now
closes the Linux glibc release gate with its own frozen artifact, formal soak,
independent source approval, hosted attestations, and complete task evidence.
