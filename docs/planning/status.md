...
| M0-011 | BLOCKED | [`docs/evidence/M0-011/README.md`](../evidence/M0-011/README.md) | Linux GATE-NET-06 acceptance passes, including production cancellation/TLS cleanup and all resource classes. A fixed four-hour Windows x86_64 supplemental gate is implemented but not yet executed; macOS and mobile native profiles remain outstanding. |
