...
| M2-004 | COMPLETE | [`docs/evidence/M2-004/README.md`](../evidence/M2-004/README.md) | Native `windows-2025` Cangjie requalification proves the bounded Win32/Winsock SystemResolver remains valid after shared Apple resolver build changes, with six selected cases passing at exact SHA `a46a6e9`; the test-only fail-closed TLS link stub is not a provider or release artifact. |
