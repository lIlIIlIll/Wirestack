...
| M0-016 | BLOCKED | [`docs/evidence/M0-016/README.md`](../evidence/M0-016/README.md) | Desktop results require rerun after adding measured ALPN no-overlap and malformed-input cases; Android/iOS/Harmony native evidence is also missing. |
