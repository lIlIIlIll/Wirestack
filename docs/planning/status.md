...
| M2-006 | INCOMPLETE | [`docs/evidence/M2-006/README.md`](../evidence/M2-006/README.md) | Apple adapter, build-time selection, fail-closed evidence validation and hosted `macos-15`/iOS Simulator gates are implemented; native exact-SHA reports are pending. |
