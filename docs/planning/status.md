...
| M8-005 | COMPLETE | [`docs/evidence/M8-005/README.md`](../evidence/M8-005/README.md) | Linux HTTP parity passes all twelve acceptance commands. HTTP facade: 102 passed, 3 skipped. HTTP protocol: 290 passed, 3 skipped. Five installed consumer modes pass, including 131,072-byte HTTP/2 push and file context-stop classification. Full check: 750 passed, 23 skipped. Selected tooling: 236 passed. API: 314 declarations, 110 aliases. Documentation: 1,443 symbols and 689 parameters, fully documented. Push workers retain cancellation and cleanup ownership, redirects release unclaimed pushes, and encoded header batches remain ordered through reset. No compression, non-Linux file, performance or final-release claim. |
