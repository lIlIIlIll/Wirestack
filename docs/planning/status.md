...
| M8-005 | COMPLETE | [`docs/evidence/M8-005/README.md`](../evidence/M8-005/README.md) | All thirteen Linux HTTP acceptance commands pass, including the pinned PSL generator check. HTTP facade: 108 passed, 3 skipped. HTTP protocol: 292 passed, 3 skipped. Five installed consumer modes cover 131,072-byte HTTP/2 push and file context-stop classification. Full check: 758 passed, 23 skipped. Selected tooling: 240 passed. API: 314 declarations, 110 aliases. Documentation: 1,443 symbols and 689 parameters, fully documented. Origin-relative PSL boundaries and secure-cookie overlay rejection protect cookie state. Transferred push bodies retain request cancellation and deadlines. Bounded mutations cover all three parsers and invalid multipart metadata closes owned input. No compression, non-Linux file, performance or final-release claim. |
