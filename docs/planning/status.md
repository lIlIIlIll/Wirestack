...
| M9-002 | COMPLETE | [#171](https://github.com/lIlIIlIll/Wirestack/issues/171); [acceptance evidence](../evidence/M9-002/README.md); [source seal](../evidence/M9-002/evidence.json); [candidate execution](../evidence/M9-002/publication.json) | Typed TCP/listener/UDP options, accepted policy and effective native queries pass on Linux x86_64 glibc with SDK 1.1.3. On unqualified builds, empty option lists preserve basic factories, explicit options remain Option/Unsupported, and Linux defaults are skipped; qualification-injected tests cover TCP/listener/UDP without claiming native support elsewhere. PR #191 carries the source/evidence seal; the owner authorized push and merge after exact-head checks. No production release qualification. |
| M9-003 | COMPLETE | [#172](https://github.com/lIlIIlIll/Wirestack/issues/172); [acceptance evidence](../evidence/M9-003/README.md); [source seal](../evidence/M9-003/evidence.json); [candidate execution](../evidence/M9-003/publication.json) | UDP disconnect, IPv4 broadcast and IPv4/IPv6 multicast membership scenarios pass on Linux x86_64 glibc; native, repository, focused regression, API compatibility, capability and generated API-doc gates pass. |
