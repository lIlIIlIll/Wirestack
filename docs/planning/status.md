...
| P1-014 | IN_PROGRESS | [`docs/evidence/P1-014/README.md`](../evidence/P1-014/README.md) | All 281 digest calls are explicitly classified as text, artifact or typed implementation; schema-v2 repository evidence, repository-wide architecture guard and Linux CRLF fault injection are implemented. Completion awaits the exact-revision GitHub Windows report; the shared workspace `scripts/check` also has two unrelated M2-004 evidence errors. |
