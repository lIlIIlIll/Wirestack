...
| M2-004 | COMPLETE | [`docs/evidence/M2-004/README.md`](../evidence/M2-004/README.md) | Native `windows-2025` Cangjie execution proves the bounded Win32/Winsock SystemResolver, complete candidate/family handling, stable errors, cancellation, Deadline and idempotent lifecycle at exact SHA `bc75e64`; the test-only fail-closed TLS link stub is not a provider or release artifact. |
...
| M2-006 | COMPLETE | [`docs/evidence/M2-006/README.md`](../evidence/M2-006/README.md) | GitHub hosted `macos-15` arm64 and iOS Simulator arm64 execution pass all seven resolver cases at exact SHA `f703e187`; reports retain platform, toolchain, source digests, cancellation, Deadline, network-change and lifecycle evidence. |
