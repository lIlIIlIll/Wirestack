...
|---|---|---|---|
| M8-001 | COMPLETE | [`docs/evidence/M8-001/README.md`](../evidence/M8-001/README.md) | Shared endpoints and bounded network contracts; retained lifecycle, writable peer-EOF state and structured I/O/close diagnostics; real-commit source-bound sealing and derived task totals. All eight task commands pass: 613 Cangjie cases pass, 23 performance cases excluded; network 23/23, tooling 33/33; API docs cover 1,093 symbols and 430 parameters. Native TCP transfer, truncated-read diagnostics and post-EOF writes pass; later protocol/privileged I/O is not claimed. |
