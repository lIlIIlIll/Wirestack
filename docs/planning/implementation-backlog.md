...
all twelve acceptance commands, including 100 network tests and twelve native
DNS scenarios. M8-005 through M8-007 remain pending and must not inherit these
socket or DNS qualification claims.
